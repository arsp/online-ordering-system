package com.online.ordering.system.order.service.dataaccess.order.mapper;

import com.online.ordering.system.domain.valueobject.*;
import com.online.ordering.system.order.service.dataaccess.order.entity.OrderAddressEntity;
import com.online.ordering.system.order.service.dataaccess.order.entity.OrderEntity;
import com.online.ordering.system.order.service.dataaccess.order.entity.OrderItemEntity;
...
public class OrderDataAccessMapper {
    ...
    public OrderEntity orderToOrderEntity(Order order){
        OrderEntity orderEntity = OrderEntity.builder()
                ...
                .shopId(order.getShopId().getValue())
    ...
    public Order orderEntityToOrder(OrderEntity orderEntity){
        return Order.builder()
                ...
                .shopId(new ShopId(orderEntity.getShopId()))
