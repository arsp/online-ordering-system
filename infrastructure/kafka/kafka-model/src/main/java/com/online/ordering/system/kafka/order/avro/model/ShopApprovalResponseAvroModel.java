...
public class ShopApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2805348313619025038L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShopApprovalResponseAvroModel\",\"namespace\":\"com.online.ordering.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"shopId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"orderApprovalStatus\",\"type\":{\"type\":\"enum\",\"name\":\"OrderApprovalStatus\",\"symbols\":[\"APPROVED\",\"REJECTED\"]}},{\"name\":\"failureMessages\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}]}");
  ...
  private com.online.ordering.system.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus;
   ...
   */
  public ShopApprovalResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID shopId, java.util.UUID orderId, java.time.Instant createdAt, com.online.ordering.system.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
    this.shopId = shopId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: orderApprovalStatus = (com.online.ordering.system.kafka.order.avro.model.OrderApprovalStatus)value$; break;
   ...
   */
  public com.online.ordering.system.kafka.order.avro.model.OrderApprovalStatus getOrderApprovalStatus() {
   ...
   * @param value the value to set.
   */
  public void setOrderApprovalStatus(com.online.ordering.system.kafka.order.avro.model.OrderApprovalStatus value) {
   ...
   */
  public static com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder newBuilder() {
    return new com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new ShopApprovalResponseAvroModel RecordBuilder
   */
  public static com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder newBuilder(com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder();
    } else {
      return new com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new ShopApprovalResponseAvroModel RecordBuilder
   */
  public static com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder newBuilder(com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel other) {
    if (other == null) {
      return new com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder();
    } else {
      return new com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShopApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder setShopId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder clearShopId() {
      shopId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder setOrderApprovalStatus(com.online.ordering.system.kafka.order.avro.model.OrderApprovalStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder clearOrderApprovalStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.online.ordering.system.kafka.order.avro.model.ShopApprovalResponseAvroModel.Builder clearFailureMessages() {
    ...
    public ShopApprovalResponseAvroModel build() {
      try {
        ...
        record.orderApprovalStatus = fieldSetFlags()[5] ? this.orderApprovalStatus : (com.online.ordering.system.kafka.order.avro.model.OrderApprovalStatus) defaultValue(fields()[5]);
